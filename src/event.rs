...
pub fn to_str(pitch: &Pitch) -> String {
    ...
    match pitch {
        Pitch::Pitch(0, o) => { s.push_str("a"); oct_fn(*o - 1, &mut s) },
        Pitch::Pitch(1, o) => { s.push_str("a+"); oct_fn(*o - 1, &mut s) }
        Pitch::Pitch(2, o) => { s.push_str("b"); oct_fn(*o - 1, &mut s) }
        Pitch::Pitch(3, o) => { s.push_str("c"); oct_fn(*o, &mut s) }
        Pitch::Pitch(4, o) => { s.push_str("c+"); oct_fn(*o, &mut s) }
        Pitch::Pitch(5, o) => { s.push_str("d"); oct_fn(*o, &mut s) }
        Pitch::Pitch(6, o) => { s.push_str("d+"); oct_fn(*o, &mut s) }
        Pitch::Pitch(7, o) => { s.push_str("e"); oct_fn(*o, &mut s) }
        Pitch::Pitch(8, o) => { s.push_str("f"); oct_fn(*o, &mut s) }
        Pitch::Pitch(9, o) => { s.push_str("f+"); oct_fn(*o, &mut s) }
        Pitch::Pitch(10, o) => { s.push_str("g"); oct_fn(*o, &mut s) }
        Pitch::Pitch(11, o) => { s.push_str("g+"); oct_fn(*o, &mut s) }
